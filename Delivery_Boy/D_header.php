...
<header class='toplevel'>
    <div class="head">
        <h1><a href="delivery_home_page.php" style="text-decoration:none ;color:black"><i style="color:black; display: inline-block;font-size:33px;" class="fas fa-home home"></i>Omnifood</a></h1>
        <form class="searchparent" action="searchExecution.php" method="post">
