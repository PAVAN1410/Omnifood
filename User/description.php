...
<body>
    ...
    <div class="navlinks" style="padding: 10px; margin:5px; font-size:18px">
        <a style="text-decoration: none; color:#0c0c91" href="user_homepage.php">
            &lt; Back to home </a>
    ...
    <div class="description">
        ...
        <div class="description_text">
            ...
            <h3 class='element'><?= "Quantity: " . $fetch['size'] ?></h3>
            <h3>You gain <?=$fetch['calories']?> calories by consuming <?=$fetch['productname']?></h3>
            ...
            <form class="form_" action="addCart.php" method="post">
                ...
                <input type="hidden" name="calories" value="<?= $fetch['calories'] ?>">
